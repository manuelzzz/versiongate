# CLI: bootstrapping the first Project and Token

Every write operation in VersionGate — publishing a Release, creating an
Application — requires a Project-scoped API Token
(see [`specs/decisions/authentication.md`](../specs/decisions/authentication.md)).
...
[`specs/decisions/bootstrap-mechanism.md`](../specs/decisions/bootstrap-mechanism.md).
...
(Adjust the DSN to match your deployment. If you're following
`docs/installation.md`'s Docker Compose setup, this is the value already
shown there.)
...
(see [`specs/decisions/authentication.md`](../specs/decisions/authentication.md)'s
...
(see [`specs/domain/project.md`](../specs/domain/project.md)). Use it as
a bearer credential on every authenticated request:
...
Project — see [`docs/publishing-releases.md`](publishing-releases.md).
